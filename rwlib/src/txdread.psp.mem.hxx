...
// Defines for memory management on the PlayStation Portable platform.
...
namespace pspMemoryPermutationData
{
    ...
    // Lets just disregard this for now, is wrong for Leeds PSP native texture anyway.
...
typedef ps2GSPixelEncodingFormats pspMemoryEncoding;
