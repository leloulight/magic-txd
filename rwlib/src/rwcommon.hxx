...
using growableArray = growableArrayEx <dataType, pulseCount, allocFlags, arrayMan, countType, _generic_growable_array_allocator>;
...
protected:
    struct dataEntry : dataType
    {
        ...
        AINLINE dataEntry( CachedConstructedClassAllocator *storage, bool isSummoned, Args... theArgs ) : dataType( theArgs... )
        {
...
public:
    ...
    {
        void *mem = intf->MemAllocate( sizeof( dataEntry ) * startCount + sizeof( summonBlockTail ) );
...
private:
    ...
    {
        void *mem = intf->MemAllocate( sizeof( dataEntry ) );
