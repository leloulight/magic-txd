...
{
    const rwConfigEnv *env = rwConfigEnvRegister.GetConstPluginStruct( this->engineInterface );
...
rwConfigEnvRegister_t rwConfigEnvRegister;

void registerConfigurationEnvironment( void )
{
    rwConfigEnvRegister.RegisterPlugin( engineFactory );
}
