...
EXTERN __nativeThreadTerminationProto@4:PROC

; STDCALL (not really)
__thread86_termProto@0 PROC
    ; in ebx we expect userdata ptr.
    push ebx

    call __nativeThreadTerminationProto@4
    
    ret
__thread86_termProto@0 ENDP
