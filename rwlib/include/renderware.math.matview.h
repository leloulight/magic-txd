...
#define MATVIEW_SKIPIMPL        MATVIEW_SKIPPARAMIMPL
    ...
    struct detcalc
    {
        ...
        struct detcalc_iter
        {
            ...
            {
                numberType ourval = detcalc <numberType, matrixType, subdetdimm, subviewmod..., matview_skip_x_constructor <iter, subviewmod...>::type>::calc( mat );
        ...
        struct detcalc_iter <subdetdimm, isPositive, subdetdimm, subviewmod...>
        {
            AINLINE static numberType calc( const matrixType& mat )
            {
                numberType val = detcalc <numberType, matrixType, subdetdimm, subviewmod..., matview_skip_x_constructor <subdetdimm, subviewmod...>::type>::calc( mat );
        ...
        AINLINE static numberType calc( const matrixType& mat )
        {
            return ( detcalc_iter <detdimm - 1, true, 0, viewmod..., matview_skip_y_constructor <0, viewmod...>::type>::calc( mat ) );
        }
    };
