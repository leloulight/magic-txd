...
{
private:
    // I would never create per-object variables like that in high-performance code.
    // But why not use new C++ features to make code look good? :-)
    ...
    inline QComboBox* createAddressingBox( void ) const
    {
    ...
    inline QComboBox* createFilterBox( void ) const
    {
...
public:
    inline RenderPropWindow( MainWindow *mainWnd, TexInfoWidget *texInfo ) : QDialog( mainWnd )
    {
